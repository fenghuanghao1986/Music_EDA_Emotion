...
%% Part2: arrange the Date w.r.t. subject Info
...
Exp_ID = Experiment_Type{i_Class};
    switch (Exp_ID)
        case 'NaoTalking'
            ...
            [FeatLabSubj_Tot_ASD,SubjList_Tot_ASD] = Funct_makeSeqFrames_Gaze(Data,T_Seq_Seg,Ind_Class);

            Data= TD_NaoTalking
            Ind_Class= 'TD';
            %define the Feature sequenc and corresponding lable for each sequence
            [FeatLabSubj_Tot_TD,SubjList_Tot_TD] = Funct_makeSeqFrames_Gaze(Data,T_Seq_Seg,Ind_Class);


            %%
            Feat_Tot_ASD_TD_Seq = [FeatLabSubj_Tot_ASD; FeatLabSubj_Tot_TD]
            FeatLabSubj_ASD_TD_Seq = [SubjList_Tot_ASD ;SubjList_Tot_TD ]

%             Lab_Tot_ASD_TD_Seq =[Label_Sequence_ASD  Label_Sequence_TD]
%             Feat_Tot_All = [ASD_NaoTalking. Feat_Tot ; TD_NaoTalking. Feat_Tot];
%             Lab_Tot_All = [ ASD_NaoTalking.Label_Tot ;  TD_NaoTalking.Label_Tot];%labels ASD(2),TD(1)
%             ClassLab_Tot_All = [ASD_NaoTalking.ClassLable_Tot ; TD_NaoTalking.ClassLable_Tot];
%             SubjSessItr_Tot_All = [ASD_NaoTalking.SubjSessItr_Tot ; TD_NaoTalking.SubjSessItr_Tot]
%             SubjList_Tot_All = [ASD_NaoTalking.SubjList_Tot ; TD_NaoTalking.SubjList_Tot]
%             
            
            save([SavingPath '\Part1_' Experiment_Type{i_Class} '_GazeFeatSeq_forHMM.mat'] , 'Feat_Tot_ASD_TD_Seq','Feat_Tot_All', ...
               'Lab_Tot_All', 'ClassLab_Tot_All', 'SubjSessItr_Tot_All', 'SubjList_Tot_All')
            break;
        case 'KidTalking'
            T_Seq_Seg = 5;
            Data= ASD_KidTalking
...
%             FeatLabSubj_ASD_TD_Seq = [SubjList_Tot_ASD ;SubjList_Tot_TD ]
% 
%             Feat_Tot_All = [ASD_KidTalking. Feat_Tot ; TD_KidTalking. Feat_Tot];
%             Lab_Tot_All = [ ASD_KidTalking.Label_Tot ;  TD_KidTalking.Label_Tot];%labels ASD(2),TD(1)
%             ClassLab_Tot_All = [ASD_KidTalking.ClassLable_Tot ; TD_KidTalking.ClassLable_Tot];
%             SubjSessItr_Tot_All = [ASD_KidTalking.SubjSessItr_Tot ; TD_KidTalking.SubjSessItr_Tot];
%             SubjList_Tot_All = [ASD_KidTalking.SubjList_Tot; TD_KidTalking.SubjList_Tot];
%             
...
%% Part3: Leave One Subjec out HMM Trainign-testing
Experiment_Type = {'NaoTalking', 'KidTalking'};

Exp_ID = 'NaoTalking'
FeatureType_ID=1;
Feat_Tot_ASD_TD_Seq{FeatureType_ID};
