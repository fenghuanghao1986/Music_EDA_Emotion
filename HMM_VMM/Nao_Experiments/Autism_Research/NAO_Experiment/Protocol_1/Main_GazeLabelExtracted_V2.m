...
% Listing = dir('D:\Mohammad\Matlab\Autism_Nao_Experiments\Data_FirstProtocol\Labels\Part1\*.txt')
% Data_Path = 'D:\Mohammad\Matlab\Autism_Nao_Experiments\Data_FirstProtocol\Labels\Part1\';
...
%         title(['Three Coding Lables (with' num2str(FPS_NaoTalking(itr)) ' fps)' ], 'fontsize',14)
        ...
        FigName = ['D:\Mohammad\Matlab\Autism_Nao_Experiments\Matlab\Figures\Labels\' Subj_Game_Sess_ID];
        saveas(h,FigName,'jpg') ;
        saveas(h,FigName,'fig') ;
    end
end
SavingPath= 'D:\Mohammad\Matlab\Autism_Nao_Experiments\Data_FirstProtocol\Labels';
...
SavingPath= 'D:\Mohammad\Matlab\Autism_Nao_Experiments\Data_FirstProtocol\Labels';
save([SavingPath '\Part1_GazeAnalysis.mat'],'Tot_Subj_Game_Sess_ID','SubjSess_Lab', 'NaoTalkingPercentage_GazeAt','NaoTalkingPercentage_GazeShifting','NaoTalkingRatio_GazeAt_Shifting', 'NaoTalkingEntropy_Shifting',...
    'KidTalkingPercentage_GazeAt', 'KidTalkingPercentage_GazeShifting', 'KidTalkingRatio_GazeAt_Shifting', 'KidTalkingEntropy_Shifting')
