...
Listing = dir('C:\Users\MahoorLab04\MMavadati_Files\Autism_Reserach\NaoExperiment\Protocol_1\GazeCoded\WholeTD\TD_Part1\*.txt')
Data_Path = 'C:\Users\MahoorLab04\MMavadati_Files\Autism_Reserach\NaoExperiment\Protocol_1\GazeCoded\WholeTD\TD_Part1\';
Figure_Path = 'C:\Users\MahoorLab04\MMavadati_Files\MATLAB\Autism_Research\NAO_Experiment\Protocol_1\Figures\TD_Gaze\'
...
%         title(['Three Coding Lables (with' num2str(FPS_NaoTalking(itr)) ' fps)' ], 'fontsize',14)
        ...
        FigName = [Figure_Path Subj_Game_Sess_ID 'TD_NaoKidTalking'];
...
save ( [SavingPath '\Part1_TD_LabGaze_KidNaoTalking.mat'],'Tot_Subj_Game_Sess_ID', 'SameFPS_EntireCodes','SameFPS_KidTalking', 'SameFPS_NaoTalking','FPS_NaoTalking','info')
...
load( [SavingPath '\Part1_TD_LabGaze_KidNaoTalking.mat'],'Tot_Subj_Game_Sess_ID', 'SameFPS_EntireCodes','SameFPS_KidTalking', 'SameFPS_NaoTalking')
...
save([SavingPath '\Part1_TD_GazeAnalysis.mat'],'Tot_Subj_Game_Sess_ID','SubjSess_Lab', 'NaoTalkingPercentage_GazeAt','NaoTalkingPercentage_GazeShifting','NaoTalkingRatio_GazeAt_Shifting', 'NaoTalkingEntropy_Shifting',...
