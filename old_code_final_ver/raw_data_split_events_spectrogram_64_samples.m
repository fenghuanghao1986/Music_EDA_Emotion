...
time_data = 'D:\event_based_emotion_redo\time_stemp_whole.csv';

raw_data_path = 'D:\event_based_emotion_redo\whole_data';
...
mkdir('D:\event_based_emotion_redo', 'Figures_spectrogram_64_raw');

save_path = 'D:\event_based_emotion_redo\Figures_spectrogram_64_raw\';
...
for file_num = 1: numel(fileNames)
    ...
    znorm_q1_filter{file_num} = medfilt1(znorm_q1.', 32);
    znorm_q2_filter{file_num} = medfilt1(znorm_q2.', 32);
    
    
%     size(znorm_q1_filter{file_num})
    ...
    for event_num = 1:1:5
        ...
        event_m_q1 = znorm_q1_filter{file_num}(current_frame: next_frame);
        event_m_q2 = znorm_q2_filter{file_num}(current_frame: next_frame);
...
%             'bicubic');
        ...
        event_m_q1_spect{file_num, event_num} = imresize(event_m_q1, [1, resize_val(2)], ...
            'bicubic');
        event_m_q2_spect{file_num, event_num} = imresize(event_m_q2, [1, resize_val(2)],...
            'bicubic');
...
%         
        save_folder = ...
            sprintf('D:\\event_based_emotion_redo\\Figures_spectrogram_64_raw\\Event_%d\\', event_num);
