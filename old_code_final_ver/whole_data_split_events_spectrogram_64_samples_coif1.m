...
mkdir('D:\event_based_emotion_redo', 'Figures_spectrogram_64_coif1');

save_path = 'D:\event_based_emotion_redo\Figures_spectrogram_64_coif1\';
...
for file_num = 1: numel(fileNames)
    ...
    for event_num = 1:1:5
        ...
        event_m_q1 = cwt(znorm_q1_filter{file_num}(current_frame: next_frame), scale_range,...
            'coif1');
        event_m_q2 = cwt(znorm_q2_filter{file_num}(current_frame: next_frame), scale_range, ...
            'coif1');
...
%         event_m_q2_spect{file_num, event_num} = (event_m_q2_spect{file_num, event_num} - BaseMean_2) ./ BaseStd_2;
        ...
        save_folder = ...
            sprintf('D:\\event_based_emotion_redo\\Figures_spectrogram_64_coif1\\Event_%d\\', event_num);
