...
for i = 1 : 66
    ...
    load(['D:\event_based_emotion_redo\Figures_spectrogram_66_cmorlet\Event_', ...
...
save(['D:\event_based_emotion_redo\Figures_spectrogram_66_cmorlet\Event_', num2str(event), ...
