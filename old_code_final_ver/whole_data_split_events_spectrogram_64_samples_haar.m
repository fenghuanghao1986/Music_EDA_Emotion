...
mkdir('D:\event_based_emotion_redo', 'Figures_spectrogram_64_haar');

save_path = 'D:\event_based_emotion_redo\Figures_spectrogram_64_haar\';
...
%         event_m_q2_spect{file_num, event_num} = (event_m_q2_spect{file_num, event_num} - BaseMean_2) ./ BaseStd_2;
        ...
        save_folder = ...
            sprintf('D:\\event_based_emotion_redo\\Figures_spectrogram_64_haar\\Event_%d\\', event_num);
