...
for i = 1 : 32
    ...
    load(['D:\event_based_emotion_redo\Figures_spectrogram_32_cmorlet\Event_', ...
...
save(['D:\event_based_emotion_redo\Figures_spectrogram_32_cmorlet\Event_', num2str(event), ...
