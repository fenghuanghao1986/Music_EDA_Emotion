...
mkdir('D:\event_based_emotion_redo', 'Figures_spectrogram_64_db1');

save_path = 'D:\event_based_emotion_redo\Figures_spectrogram_64_db1\';
...
%         event_m_q2_spect{file_num, event_num} = (event_m_q2_spect{file_num, event_num} - BaseMean_2) ./ BaseStd_2;
       ...
       numel(find(isnan(event_m_q2_spect{file_num, event_num})==1)) 
       numel(find(isnan(event_m_q1_spect{file_num, event_num})==1)) 
       
        save_folder = ...
            sprintf('D:\\event_based_emotion_redo\\Figures_spectrogram_64_db1\\Event_%d\\', event_num);
