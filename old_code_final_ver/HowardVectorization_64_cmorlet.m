...
for i = 1 : 64
    ...
    load(['D:\event_based_emotion_redo\Figures_spectrogram_64_cmorlet_again\Event_', ...
...
save(['D:\event_based_emotion_redo\Figures_spectrogram_64_cmorlet_again\Event_', num2str(event), ...
