...
event_1 = load(['D:\event_based_emotion_redo\Figures_spectrogram_64_cmorlet_again\Event_1\event_1_', qsensor]);
event_1 = event_1.output;
event_2 = load(['D:\event_based_emotion_redo\Figures_spectrogram_64_cmorlet_again\Event_2\event_2_', qsensor]);
event_2 = event_2.output; 
event_3 = load(['D:\event_based_emotion_redo\Figures_spectrogram_64_cmorlet_again\Event_3\event_3_', qsensor]);
event_3 = event_3.output;
event_4 = load(['D:\event_based_emotion_redo\Figures_spectrogram_64_cmorlet_again\Event_4\event_4_', qsensor]);
event_4 = event_4.output;
event_5 = load(['D:\event_based_emotion_redo\Figures_spectrogram_64_cmorlet_again\Event_5\event_5_', qsensor]);
event_5 = event_5.output; 


% event_1 = load(['D:\event_based_emotion_redo\6_features\event_1_', qsensor, '_6_features.mat']);
% event_1 = event_1.StatSave;
% event_2 = load(['D:\event_based_emotion_redo\6_features\event_1_', qsensor, '_6_features.mat']);
% event_2 = event_2.StatSave;
% event_3 = load(['D:\event_based_emotion_redo\6_features\event_1_', qsensor, '_6_features.mat']);
% event_3 = event_3.StatSave;
% event_4 = load(['D:\event_based_emotion_redo\6_features\event_1_', qsensor, '_6_features.mat']);
% event_4 = event_4.StatSave;
% event_5 = load(['D:\event_based_emotion_redo\6_features\event_1_', qsensor, '_6_features.mat']);
% event_5 = event_5.StatSave;
...
Percision2 = ConfMat(2,2) / (ConfMat(2,2) + ConfMat(2,1));
Recall2 = ConfMat(2,2) / (ConfMat(2,2) + ConfMat(1,2));
