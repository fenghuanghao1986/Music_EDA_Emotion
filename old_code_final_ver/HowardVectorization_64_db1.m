...
for i = 1 : 64
    ...
    load(['D:\event_based_emotion_redo\Figures_spectrogram_64_db1\Event_', ...
...
save(['D:\event_based_emotion_redo\Figures_spectrogram_64_db1\Event_', num2str(event), ...
