...
event_1 = load(['D:\event_based_emotion_redo\Figures_spectrogram_64_haar\Event_1\event_1_', qsensor]);
event_1 = event_1.output;
event_2 = load(['D:\event_based_emotion_redo\Figures_spectrogram_64_haar\Event_2\event_2_', qsensor]);
event_2 = event_2.output;
event_3 = load(['D:\event_based_emotion_redo\Figures_spectrogram_64_haar\Event_3\event_3_', qsensor]);
event_3 = event_3.output;
event_4 = load(['D:\event_based_emotion_redo\Figures_spectrogram_64_haar\Event_4\event_4_', qsensor]);
event_4 = event_4.output;
event_5 = load(['D:\event_based_emotion_redo\Figures_spectrogram_64_haar\Event_5\event_5_', qsensor]);
event_5 = event_5.output;
