...
for file_num = 1: numel(fileNames)
    ...
    for expression_num = 1:6
        ...
        mkdir('D:\Howard_Feng\georgia_tech\espression_test\Expression', sprintf('Expression_%s', expression));
        ...
        if loop_num ~= 0;
            ...
            for i = 1:loop_num
                ...
                save_folder = ...
                    sprintf('D:\\Howard_Feng\\georgia_tech\\espression_test\\Expression\\Expression_%s\\', expression);
