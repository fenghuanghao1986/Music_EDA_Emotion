...
%% 5 classes
expression_0 = load(['D:\expression_test_redo\Raw_Expression\Expression_Neutral\expression_Neutral_', 'q2']);
expression_0 = expression_0.output;
expression_1 = load(['D:\expression_test_redo\Raw_Expression\Expression_Smile_1\expression_Smile_1_', 'q2']);
expression_1 = expression_1.output;
expression_2 = load(['D:\expression_test_redo\Raw_Expression\Expression_Smile_2\expression_Smile_2_', 'q2']);
expression_2 = expression_2.output;
expression_3 = load(['D:\expression_test_redo\Raw_Expression\Expression_Smile_3\expression_Smile_3_', 'q2']);
expression_3 = expression_3.output;
expression_4 = load(['D:\expression_test_redo\Raw_Expression\Expression_Negative\expression_Negative_', 'q2']);
expression_4 = expression_4.output;
expression_5 = load(['D:\expression_test_redo\Raw_Expression\Expression_Hat\expression_Hat_', 'q2']);
...
expression_0 = load(['D:\expression_test_redo\Raw_Expression\Expression_Neutral\expression_Neutral_', 'q1']);
expression_0 = expression_0.output;
expression_1 = load(['D:\expression_test_redo\Raw_Expression\Expression_Smile_1\expression_Smile_1_', 'q1']);
expression_1 = expression_1.output;
expression_2 = load(['D:\expression_test_redo\Raw_Expression\Expression_Smile_2\expression_Smile_2_', 'q1']);
expression_2 = expression_2.output;
expression_3 = load(['D:\expression_test_redo\Raw_Expression\Expression_Smile_3\expression_Smile_3_', 'q1']);
expression_3 = expression_3.output;
expression_4 = load(['D:\expression_test_redo\Raw_Expression\Expression_Negative\expression_Negative_', 'q1']);
expression_4 = expression_4.output;
expression_5 = load(['D:\expression_test_redo\Raw_Expression\Expression_Hat\expression_Hat_', 'q1']);
expression_5 = expression_5.output;
