...
%                   EventName{2}, ' & ', EventName{3}],  'ProbConfMatSVM', 'AccuracySVM') 
        ...
        %           EventName{2}, ' & ', EventName{3}],  'ProbConfMatKNN', 'AccuracyKNN') 
            ...
            save(['E:\EDA_Process\C_Morlet_SVM\results_10_12_10\svmLinear\1v2\SVM_', KernelName, '_', 'vec_warm_seg_', num2str(a), ' & ', ...
...
%             save(['E:\EDA_Process\C_Morlet_SVM\results_10_12_10\knn1\1v2\KNN_K', num2str(K), '_', 'vec_warm_seg_', num2str(a), ' & ', ...
...
%         KernelName = 'RBF';
        ...
        %           EventName{2}, ' & ', EventName{3}],  'ProbConfMatKNN', 'AccuracyKNN') 
            ...
            [ConfMatSVM, PercisionSVM, RecallSVM, AccuracySVM, aucSVM, ~, ~, AvePercisionSVM, AveRecallSVM] = ...
                                     PRA(SaveTestLabel, SVMLabels_M, deciSVM,['SVM-', KernelName]);
            save(['E:\EDA_Process\C_Morlet_SVM\results_10_12_10\svmLinear\1v3\SVM_', KernelName, '_', 'vec_warm_seg_', num2str(a), ' & ', ...
            ...
            [ConfMatKNN, PercisionKNN, RecallKNN, AccuracyKNN, aucKNN, ~, ~, AvePercisionKNN, AveRecallKNN] = ... 
                                     PRA(SaveTestLabel, KNNLabels_M, deciKNN, ['KNN-K', num2str(K)]); 
%             save(['E:\EDA_Process\C_Morlet_SVM\results_10_12_10\knn1\1v3\KNN_K', num2str(K), '_', 'vec_warm_seg_', num2str(a), ' & ', ...
