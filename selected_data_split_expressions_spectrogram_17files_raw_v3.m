...
%     znorm_q2_filter{file_num} = medfilt1(znorm_q2.', 1); 
    ...
    znorm_q1_filter{file_num} = znorm_q1;
    znorm_q2_filter{file_num} = znorm_q2; 
    ...
    for expression_num = 1:6
        ...
        mkdir('D:\expression_test_redo\Raw_Expression', sprintf('Expression_%s', expression));
...
%         
                save_folder = ...
                    sprintf('D:\\expression_test_redo\\Raw_Expression\\Expression_%s\\', expression);
                ...
                title(sprintf('subject %d expression %s, q1, znorm filt data', file_num, expression));
                subplot(2,1,2);
                ...
                title(sprintf('subject %d expression %s, q2, znorm filt data', file_num, expression));
                subplot(2,1,2);
