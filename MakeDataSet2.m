...
function [DataSet] = MakeDataSet2(SubjectName,InterestedTasks,DataType,DownSamp,All_OR_Each,ECoG_OR_LFP)
...
for b2=1:numel(InterestedTasks)
    ...
    for b3=1:3
        ...
        LeftSide{b3}=(downsample(TempData1',DownSamp))'; 
%         LeftSide{b3}=Block_Cropper(TempData1,1,DownSamp,'size');
    ...
    for b4=1:3
        ...
        RightSide{b4}=(downsample(TempData2',DownSamp))';
%         RightSide{b4}=Block_Cropper(TempData2,1,DownSamp,'size');
