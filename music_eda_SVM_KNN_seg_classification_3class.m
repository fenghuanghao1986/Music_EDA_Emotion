...
%             KernelName = 'RBF';
            ...
            if TaskNumb ~= 2
                ...
                save(['E:\EDA_Process\C_Morlet_SVM\results_10_12_10\1v2v3\svmLinear\SVM_', KernelName, '_', 'vec_warm_seg_', num2str(a), ' & ', ...
                ...
                save(['E:\EDA_Process\C_Morlet_SVM\results_10_12_10\1v2v3\knn1\KNN_K', num2str(K), '_', 'vec_warm_seg_', num2str(a), ' & ', ...
...
%             KernelName = 'RBF';
            ...
            if TaskNumb ~= 2
                ...
                AccuracySVM = numel(find(SVMLabels_M == SaveTestLabel)) / numel(SaveTestLabel);
                [~, ProbConfMatSVM] = ConfusionMatrix(SaveTestLabel, SVMLabels_M);
                save(['E:\EDA_Process\C_Morlet_SVM\results_10_12_10\1v2v3\svmPoly\SVM_', KernelName, '_', 'vec_warm_seg_', num2str(a), ' & ', ...
                      'vec_inter_seg_', num2str(b), ' & ', 'vec_game_seg_', num2str(c)],  'ProbConfMatSVM', 'AccuracySVM') 
                disp(['SVM Accuracy: ', num2str(AccuracySVM)])
                disp('SVM ConfMat: ');
                disp(num2str(ProbConfMatSVM))
                ...
                AccuracyKNN = numel(find(KNNLabels_M == SaveTestLabel)) / numel(SaveTestLabel);    
                [~, ProbConfMatKNN] = ConfusionMatrix(SaveTestLabel, KNNLabels_M);
                save(['E:\EDA_Process\C_Morlet_SVM\results_10_12_10\1v2v3\knn3\KNN_K', num2str(K), '_', 'vec_warm_seg_', num2str(a), ' & ', ...
                      'vec_inter_seg_', num2str(b), ' & ', 'vec_game_seg_', num2str(c)],  'ProbConfMatKNN', 'AccuracyKNN') 
                disp(['KNN Accuracy: ', num2str(AccuracyKNN)])
                disp('KNN ConfMat: ');
                disp(num2str(ProbConfMatKNN))   
...
%             KernelName = 'Polynomial';
            ...
            if TaskNumb ~= 2
                ...
                AccuracySVM = numel(find(SVMLabels_M == SaveTestLabel)) / numel(SaveTestLabel);
                [~, ProbConfMatSVM] = ConfusionMatrix(SaveTestLabel, SVMLabels_M);
                save(['E:\EDA_Process\C_Morlet_SVM\results_10_12_10\1v2v3\svmRBF\SVM_', KernelName, '_', 'vec_warm_seg_', num2str(a), ' & ', ...
                      'vec_inter_seg_', num2str(b), ' & ', 'vec_game_seg_', num2str(c)],  'ProbConfMatSVM', 'AccuracySVM') 
                disp(['SVM Accuracy: ', num2str(AccuracySVM)])
                disp('SVM ConfMat: ');
                disp(num2str(ProbConfMatSVM))
                ...
                AccuracyKNN = numel(find(KNNLabels_M == SaveTestLabel)) / numel(SaveTestLabel);    
                [~, ProbConfMatKNN] = ConfusionMatrix(SaveTestLabel, KNNLabels_M);
                save(['E:\EDA_Process\C_Morlet_SVM\results_10_12_10\1v2v3\knn7\KNN_K', num2str(K), '_', 'vec_warm_seg_', num2str(a), ' & ', ...
                      'vec_inter_seg_', num2str(b), ' & ', 'vec_game_seg_', num2str(c)],  'ProbConfMatKNN', 'AccuracyKNN') 
                disp(['KNN Accuracy: ', num2str(AccuracyKNN)])
                disp('KNN ConfMat: ');
                disp(num2str(ProbConfMatKNN))   
