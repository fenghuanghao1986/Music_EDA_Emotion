...
time_file = 'D:\espression_test\all_expression_time_stemp.csv';
select_data_path = 'D:\espression_test\select_data';
fileType = '*.csv';
...
for file_num = 1: numel(fileNames)
    ...
    for expression_num = 1:6
        ...
        mkdir('D:\espression_test\Expression', sprintf('Expression_%s', expression));
...
%         
                save_folder = ...
                    sprintf('D:\\espression_test\\Expression\\Expression_%s\\', expression);
