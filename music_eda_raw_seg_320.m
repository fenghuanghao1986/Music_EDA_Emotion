...
%         znormCWT = abs(cwt(znormFilter, scaleRange, 'cmor1.5-2'));
        ...
        znormCWTCubic = imresize(znormFilter, [100, 1440], 'bicubic');
...
%         znormCWTSpect = (znormCWTCubic - BaseMean) ./ BaseStd;
    ...
    %     Alienware path
        saveFolder = ...
            sprintf('E:\\EDA_Process\\C_Morlet_SVM\\segRawData\\inter_seg\\');
        % Surface path
    %     saveFolder = ...
...
%         znormCWTSpect = (znormCWTCubic - BaseMean) ./ BaseStd;
    ...
    %     Alienware path
        saveFolder = ...
            sprintf('E:\\EDA_Process\\C_Morlet_SVM\\segRawData\\game_seg\\');
        % Surface path
    %     saveFolder = ...
    %         sprintf('C:\\Users\\fengh\\pythonProject\\NAO_Autism_Music_Project\\EDA_Process\\C_Morlet_SVM\\warmup\\');
...
%         znormCWTSpect = (znormCWTCubic - BaseMean) ./ BaseStd;
    ...
    %     Alienware path
        saveFolder = ...
            sprintf('E:\\EDA_Process\\C_Morlet_SVM\\segRawData\\warm_seg\\');
